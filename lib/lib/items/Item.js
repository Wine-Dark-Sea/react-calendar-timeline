  ...
  function Item(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onMouseUp", function (e) {
      if (!_this.state.interactMounted && _this.startedClicking) {
        ...
        if (Math.abs(_this._originClickX - e.clientX) <= _this.props.clickTolerance) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onTouchStart", function (e) {
      if (!_this.state.interactMounted) {
        _this._originClickX = e.touches[0].clientX;
        e.preventDefault();
    ...
    _defineProperty(_assertThisInitialized(_this), "onTouchEnd", function (e) {
      if (!_this.state.interactMounted && _this.startedTouching) {
        ...
        if (Math.abs(_this._originClickX - e.changedTouches[0].clientX) <= _this.props.clickTolerance) {
